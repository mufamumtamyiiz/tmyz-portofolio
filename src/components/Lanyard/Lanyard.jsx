...
// Public assets must include Vite's base path so they work both locally and
// when the site is served from GitHub Pages at /portofolio/.
const cardGLB = `${import.meta.env.BASE_URL}assets/new%20card.glb`;
